        ...
        <div className="h-full flex flex-col w-full ">
            ...
            <div className="flex-none flex h-[25px] bg-gray-300 my-2 mx-3 rounded-full relative dark:bg-theme-neutral-800">
                {walletInfor?.role === "master" ? (
                    <button
                        className={`px-[14%] rounded-full text-xs cursor-pointer font-medium uppercase text-center ${activeTab === "trade" ? "bg-gradient-to-t dark:bg-gradient-to-t from-theme-purple-100 to-theme-blue-100 text-white dark:from-theme-primary-500 dark:to-theme-secondary-400" : "text-neutral-400"
                            }`}
                    ...
                    <button
                        className={`px-[14%] rounded-full text-xs cursor-pointer font-medium uppercase text-center ${activeTab === "chatAll" ? "bg-gradient-to-t dark:bg-gradient-to-t from-theme-purple-100 to-theme-blue-100 text-white dark:from-theme-primary-500 dark:to-theme-secondary-400" : "text-neutral-400"
                            }`}
                ...
                <button
                    className={`flex-1 rounded-full cursor-pointer text-xs font-medium uppercase text-center ${activeTab === "chat" ? "bg-gradient-to-t dark:bg-gradient-to-t from-theme-purple-100 to-theme-blue-100 text-white dark:from-theme-primary-500 dark:to-theme-secondary-400" : "text-neutral-400"
                        }`}
